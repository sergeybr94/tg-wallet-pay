 ...
 */
class OrderPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPreview';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pay_link', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pay_link'] === null) {
            $invalidProperties[] = "'pay_link' can't be null";
        }
     ...
     * Sets number
     *
     * @param string $number Human-readable short order id for UI
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $completed_date_time ISO-8601 date time when order was completed (paid/expired/etc)
     *
     * @return self
     */
     ...
     * Sets pay_link
     *
     * @param string $pay_link URL to show payer on Store's side
     *
     * @return self
     */
    ...
    {
        if (is_null($pay_link)) {
            throw new \InvalidArgumentException('non-nullable pay_link cannot be null');
        }
